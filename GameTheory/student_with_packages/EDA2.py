...
# Filter out data for Day 4
data = data[data['Date'] != 4]
...
plt.title('Price Trends Over Time for Follower 2')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()
plt.show()
...
plt.title('Regression Analysis for Follower 2')
...
plt.title('Daily Price Changes for Follower 2')
plt.xlabel('Date')
